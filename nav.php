...
<title>Hari agro overseas</title>
<meta name="description" content="">
<meta name="viewport" content="width=device-width, initial-scale=1">
<!-- Place favicon.ico in the root directory -->
<link rel="shortcut icon" type="image/x-icon" href="image/logo/loader.png">
<!-- CSS here -->
...
<body class="rs-smoother-yes rtl">
    ...
    <div id="pre-load">
        <div id="loader" class="loader">
            <div class="loader-container has-theme-red">
                <div class="loader-icon"><img src="image/logo/loader.png" alt=""></div>
            </div>
        </div>
    </div>
    <!-- preloader end -->
    ...
    <!-- Header area start -->
    <header>
        <div class="rs-header-area rs-header-two header-transparent has-theme-red has-border bg-white"
            id="header-sticky">
            <div class="container-fluid">
                <div class="rs-header-inner">
                    <div class="rs-header-left">
                        <div class="rs-header-logo p-0">
                            <a href="index"><img src="image/logo/logo.jpg" width="300px" alt="logo"></a>
                        </div>
                    </div>
                            ...
                            <ul class="multipage-menu">
                                ...
                                <!-- <li class="menu-item-has-children">
                                    ...
                                    <ul class="submenu last-children">
                                        <li>
                                            <a href="about">About Us 01</a>
                                        </li>
                                        <li>
                                            <a href="about-two">About Us 02</a>
                                        </li>
                                    </ul>
                                </li> -->
                                <!-- page menu -->
                    ...
                    <div class="rs-header-right">
                        ...
                        <div class="rs-header-call ">
                            <h6><a href="tel:" class="text-black">Call Now </a></h6>
                        </div>
                        <!-- call end -->

                        <!-- search start -->
                        <div class="rs-header-search-wrapper">
                            <div class="rs-header-search-icon has-theme-red text-black">
                                <i class="ri-close-fill has-close"></i>
                                <i class="ri-search-line has-search"></i>
                            </div>
                            <form class="text-black  rs-header-search-inner rs-stickys-form" action="#" method="POST">
                        ...
                        <!-- sidebar start -->
                        <div class="rs-header-hamburger has-theme-red text-black">
            ...
            <div class="offcanvas-wrapper">
                <div class="offcanvas-content">
                    ...
                    <div class="offcanvas-about mb-30 d-none d-sm-block">
                        <p> Hari Agro Overseas is a trusted name in the global agricultural trade, committed to
                            delivering premium-quality grains from the heart of India to markets around the world. Based
                            in Balu, Haryana, we specialize in the export of Basmati Rice, Non-Basmati Rice, 1121
                            Basmati Rice, and Wheat — products that reflect our dedication to quality, authenticity, and
                            sustainability.
                        </p>
                    </div>
                        ...
                        <ul>
                            <li class="d-flex align-items-center gap-15">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="#"> 725, Balu, Haryana – 132024 ,India </a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center gap-15">
                                <div class="offcanvas-contact-icon">
                            ...
                            <li class="d-flex align-items-center gap-15">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="mailto:info@gmail.com">guptarahul989@gmail.com
                                        | hariagrooverseas989@gmail.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
